...
# Editado para Wikipedia PT.. Tuve un error
class DataRetriever():

    def __init__(self, system_id, data_files_base):
        self.system_id = system_id
	wikidx = os.getcwd() + '/pt_lat/' + 'ptwiki-20121210-pages-articles.xml.processed.bz2t'
	wiki = os.getcwd() + '/pt_lat/' + 'ptwiki-20121210-pages-articles.xml.processed.bz2'
        self._bzip_file_name = wiki
        self._bzip_table_file_name = wikidx
